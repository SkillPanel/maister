window.MAISTER_DATA = {
  "generated": "2026-08-24T11:15:40Z",
  "task": {
    ...
    "current_activity": "Gate approve answered (proceed); the per-repo development node is running."
  },
  "characteristics": {
    "chain": true,
    "provider": "claude"
  ...
  "phases": [
    ...
    },
    {
      ...
      "completed": "2026-08-24T11:15:40Z",
      "skip_reason": null,
      "summary": "Operator chose proceed.",
      "decisions": [
        {
          "decision": "Proceed to implementation in the researched order",
          "rationale": "The shared client package forces repo-alpha before repo-beta."
        }
      ],
      "risks": [],
      "artifacts": [],
      "gate": {
        ...
        "answer": "Proceed to implementation"
      }
    },
    {
      "id": "dev",
