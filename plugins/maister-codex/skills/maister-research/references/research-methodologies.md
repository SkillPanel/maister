...
**Tools**:
- rg --files: File pattern matching
- rg: Code pattern searching
...
**Tools**:
- rg --files: Find requirement documents
- Read: Document analysis
- rg: Search for keywords (requirement, must, should, acceptance criteria)
...
- page open/fetch: Read external documentation
...
- Use rg --files to find all potentially relevant files
