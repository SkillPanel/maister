...
- Restart from phase: `MAISTER_WORKFLOW_PROSE=1`, then `skill: "maister:development"` with `args: "--resume .maister/tasks/development/2025-10-26-auth --from=verify"` — the phase flag is a prose-path capability
