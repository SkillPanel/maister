...
| Complexity | Exploration Questions | Convergence Areas | Spec Sections | Refinement Patience |
|---|---|---|---|---|
| Simple | 2-3 | 1-2 | 3-4 | 2 iterations (soft cap) |
| Standard | 4-6 | 2-3 | 5-6 | 3 iterations (soft cap) |
| Complex / Greenfield | 8-10 | 3-5 | 6-8 | 3 iterations (soft cap) |
