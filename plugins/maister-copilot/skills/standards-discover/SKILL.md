...
5. **Invoke `docs-manager` skill** to verify .github/copilot-instructions.md integration — ensure standards directory is referenced. **⚠️ CONTINUATION**: After docs-manager returns, immediately display the application summary below.
