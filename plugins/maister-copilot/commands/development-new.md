...
Start any development task — bug fix, enhancement, or new feature. The workflow adapts based on detected task characteristics.

## Usage

```
/maister-development-new [description] [--yolo] [--from=PHASE] [--e2e] [--user-docs] [--code-review] [--research=PATH]
```
...
/maister-development-new "Update login flow"
...
- Task output: `.maister/tasks/development/YYYY-MM-DD-name/`
