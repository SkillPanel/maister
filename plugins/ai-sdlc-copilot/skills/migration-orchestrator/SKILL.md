...
**Execute**: Task tool - `ai-sdlc-copilot/gap-analyzer` subagent
...
3. Task tool - `ai-sdlc-copilot/specification-creator` subagent
...
**Execute**: Skill tool - `ai-sdlc-copilot/implementer`
...
**Execute**: Skill tool - `ai-sdlc-copilot/implementation-verifier`
...
Invoked via:
- `/ai-sdlc-copilot/migration:new [description] [--yolo] [--type=TYPE]`
- `/ai-sdlc-copilot/migration:resume [task-path] [--from=PHASE]`
