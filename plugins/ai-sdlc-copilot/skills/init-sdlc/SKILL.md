...
Check if `.ai-sdlc/` directory already exists.
...
Also scan `.ai-sdlc/docs/standards/*/` for any existing custom categories to include.
...
Write each file to `.ai-sdlc/docs/project/`.
...
> "Regenerate INDEX.md to include all newly created project documentation. Then verify .github/copilot-instructions.md is properly integrated with .ai-sdlc/docs/ documentation."
...
- If `.ai-sdlc/docs/` creation fails: check permissions, suggest manual creation
