...
**ACTION REQUIRED**: This command delegates to a different skill. The `<command-name>` tag refers to THIS command, not the target. Call the Task tool with subagent_type="ai-sdlc-copilot/reality-assessor" NOW. Pass the task path in the prompt. Do not read files, explore code, or execute workflow steps yourself.
...
```
User: /ai-sdlc-copilot/reviews:reality-check .ai-sdlc/tasks/new-features/2025-11-17-payment-processing/
```

**Example 2**: Verify claimed completion
```
User: /ai-sdlc-copilot/reviews:reality-check .ai-sdlc/tasks/bug-fixes/2025-11-17-login-timeout/
```

**Example 3**: Production readiness check
```
User: /ai-sdlc-copilot/reviews:reality-check .ai-sdlc/tasks/enhancements/2025-11-17-user-dashboard/ --production
```
